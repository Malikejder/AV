...
# API Anahtarlarını buraya doğrudan tırnak içine yapıştırabilirsin kral
API_KEYS = {
    "shodan": "Lo02DVphitf8lcji0W5GxAumOQ9YaGlh", 
    "abuseipdb": "0c7b8e31a739c4fda4e8f0439cdf18f0828be479e28f33891053db234aee97dcd55cb840e65f170d", 
    "threatfox": "519f73a81b6ba26e4c5ccc5c036862e4f47a769b14d73b76", 
    "malwarebazaar": "519f73a81b6ba26e4c5ccc5c036862e4f47a769b14d73b76" 
}
...
{RED}{BOLD}
  ...
  ╚══════╝ ╚════╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝    ╚═╝  ╚═╝  ╚═══╝
{RESET}{DIM}
  [ EJDER#AV v4.2 | ThreatFox · MalwareBazaar · Shodan · AbuseIPDB · Feodo · FireHOL · CINS ]
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{RESET}
""")
...
{BOLD}  {RED}┌──────────────────────────────────────────────────┐{RESET}
  ...
  {RED}└──────────────────────────────────────────────────┘{RESET}""")
        ...
        if   ch=="1":
            ...
            print(f"\n  {DIM}EJDER#AV kapaniyor... Guvende kalin!{RESET}\n"); sys.exit(0)
        else:
            print(f"  {YELLOW}Gecersiz secim.{RESET}")

def main():
    ap = argparse.ArgumentParser(description="EJDER#AV v4.2")
